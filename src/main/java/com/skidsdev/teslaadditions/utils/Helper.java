...
{	
	...
	public static boolean areItemStacksStackable(ItemStack stackA, ItemStack stackB) { return areItemStacksStackable(stackA, stackB, 64); }
	public static boolean areItemStacksStackable(ItemStack stackA, ItemStack stackB, int maxStackSize)
	{
		return (areItemsStackable(stackA, stackB) && stackA.stackSize + stackB.stackSize <= maxStackSize);
	}
